...
{{
    "decisions": "{{\"decision\": \"Увеличить бюджет\", \"decision_maker\": \"Иван\"}}"
}}
"""
        ...
        try:
            ...
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": "Ты - опытный бизнес-аналитик и эксперт по составлению протоколов. Отвечай только валидным JSON."},
...
"""
        ...
        data = {
            ...
            "messages": [
                {
                    "role": "system",
                    "text": "Ты - опытный бизнес-аналитик и эксперт по составлению протоколов. Отвечай только валидным JSON."
                },
                {
                    "role": "user", 
                    "text": prompt
