...
def _build_user_prompt(
    ...
    if speaker_mapping:
        ...
        participants_info = "\n\n" + "═" * 63 + "\n"
        participants_info += "ПОЛНЫЙ СПИСОК УЧАСТНИКОВ ВСТРЕЧИ\n"
        participants_info += "═" * 63 + "\n\n"
        ...
        participants_info += "В секции 'Участники' протокола используй ТОЛЬКО И ИСКЛЮЧИТЕЛЬНО имена\n"
        participants_info += "ИЗ СПИСКА ВЫШЕ в формате 'Имя Фамилия' (БЕЗ отчества)!\n"
        participants_info += "КОПИРУЙ имена ТОЧНО как они указаны в списке участников!\n\n"
        participants_info += "❌ НЕПРАВИЛЬНО: 'Софья', 'Галина', 'Владимир'\n"
        ...
        participants_info += "📌 КАК СОПОСТАВЛЯТЬ ИМЕНА ИЗ ТРАНСКРИПЦИИ:\n"
        participants_info += "В транскрипции люди говорят сокращенно (Света, Леша, Викулин).\n"
        participants_info += "Твоя задача - найти в списке выше соответствующее ПОЛНОЕ ИМЯ:\n\n"
        participants_info += "Примеры сопоставления:\n"
        participants_info += "   • 'Света' в транскрипции → ищи 'Светлана' в списке → используй 'Светлана Короткова'\n"
        participants_info += "   • 'Леша' в транскрипции → ищи 'Алексей' в списке → используй 'Алексей Тимченко'\n"
        participants_info += "   • 'Викулин' в транскрипции → ищи фамилию в списке → используй полное имя\n"
        participants_info += "   • 'Володь'/'Вова' → ищи 'Владимир' → используй 'Владимир Голиков'\n"
        participants_info += "   • 'Галя' → ищи 'Галина' → используй 'Галина Ямкина'\n\n"
        participants_info += "⚡ Анализируй ВЕСЬ список участников выше!\n"
        participants_info += "⚡ В протоколе пиши имена ТОЧНО как в списке: 'Имя Фамилия'!\n"
...
def _build_extraction_prompt(
    ...
    if speaker_mapping:
        ...
        participants_info = "\nПОЛНЫЙ СПИСОК УЧАСТНИКОВ ВСТРЕЧИ:\n"
        from src.services.participants_service import participants_service
        participants_info += participants_service.format_participants_for_llm(participants)
        participants_info += "\n\n🚨 КРИТИЧЕСКИ ВАЖНО - ФОРМАТ ИМЕН:\n"
        participants_info += "Используй имена ИЗ СПИСКА ВЫШЕ в формате 'Имя Фамилия' (БЕЗ отчества)!\n"
        participants_info += "КОПИРУЙ имена ТОЧНО как указаны в списке!\n\n"
        participants_info += "❌ НЕПРАВИЛЬНО: 'Софья', 'Галина'\n"
        participants_info += "✅ ПРАВИЛЬНО: 'Софья Осипова', 'Галина Ямкина'\n\n"
        participants_info += "📌 СОПОСТАВЛЕНИЕ:\n"
        participants_info += "В транскрипции сокращенно (Света, Леша, Викулин).\n"
        participants_info += "Находи в списке выше и используй ПОЛНОЕ ИМЯ:\n"
        participants_info += "   • 'Света' → 'Светлана Короткова'\n"
        participants_info += "   • 'Леша' → 'Алексей Тимченко'\n"
        participants_info += "   • 'Викулин' → найди фамилию в списке\n\n"
        participants_info += "⚡ В протоколе пиши 'Имя Фамилия' из списка!\n\n"
