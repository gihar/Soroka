...
def _build_system_prompt(
    ...
    return (
        ...
        "СОПОСТАВЛЕНИЕ ИМЕН УЧАСТНИКОВ:\n"
        "При работе с именами участников автоматически сопоставляй варианты упоминаний:\n\n"
        ...
        "   - Тимченко → Алексей Тимченко (если в списке участников)\n"
        "   - Короткова → Светлана Короткова (если в списке участников)\n"
        "   - Сопоставляй с полным именем из списка участников\n\n"
        ...
        "   - Если сопоставление невозможно - используй имя как в транскрипции\n\n"
        "ПРИМЕРЫ СОПОСТАВЛЕНИЯ:\n"
        "   - 'Света сказала...' → используй 'Светлана Короткова' в протоколе\n"
        "   - 'Леша ответственный' → используй 'Алексей Тимченко'\n"
        "   - 'Тимченко предложил' → используй 'Алексей Тимченко'\n\n"
...
def _build_user_prompt(
    ...
    if speaker_mapping:
        ...
        participants_info += "   • Уменьшительные: Света→Светлана, Леша→Алексей, Саша→Александр\n"
        participants_info += "   • По фамилии: Тимченко→Алексей Тимченко, Короткова→Светлана Короткова\n"
...
def _build_extraction_prompt(
    ...
    if speaker_mapping:
        ...
        participants_info += "📌 СОПОСТАВЛЕНИЕ ИМЕН:\n"
        participants_info += "Если в транскрипции встречаются сокращенные имена (Света, Леша) или\n"
        participants_info += "только фамилии (Тимченко, Короткова) — сопоставляй их с полными именами\n"
        participants_info += "из списка участников выше. В протоколе используй ПОЛНОЕ ИМЯ.\n\n"
...
6. СОПОСТАВЛЕНИЕ ИМЕН:
   - Все ли сокращенные имена (Света, Леша) заменены на полные из списка участников?
   - Все ли упоминания по фамилии (Тимченко) заменены на полное имя?
...
СОПОСТАВЛЕНИЕ ИМЕН:
- Если в сегментах встречаются сокращенные имена (Света, Леша) или только фамилии (Тимченко)
...
- Примеры: Света→Светлана Короткова, Леша→Алексей Тимченко, Тимченко→Алексей Тимченко
