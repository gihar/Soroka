...
def _build_system_prompt(
    ...
    return (
        ...
        "Если в транскрипции упоминаются участники сокращенно/неполно, ОБЯЗАТЕЛЬНО сопоставляй\n"
        "их с полными именами из предоставленного списка участников.\n\n"
        "Применяй следующие принципы сопоставления ко ВСЕМ участникам из списка:\n\n"
