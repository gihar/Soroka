...
СОПОСТАВЛЕНИЕ ИМЕН:
- Автоматически сопоставляй сокращенные имена с полными из списка участников
- Уменьшительные: Света→Светлана, Леша→Алексей, Саша→Александр, Женя→Евгений
- По фамилии: Тимченко→Алексей Тимченко (если есть в списке участников)
...
СОПОСТАВЛЕНИЕ ИМЕН:
- Автоматически сопоставляй сокращенные/разговорные имена с полными
- Уменьшительные: Света→Светлана, Леша→Алексей, Саша→Александр
- По фамилии: Тимченко→Алексей Тимченко (если есть в списке)
