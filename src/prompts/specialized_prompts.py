...
- Участники: перечисление с новой строки, например "Иван Петров\\nМария Сидорова\\nАлексей Смирнов"
...
ПРИМЕР НЕПРАВИЛЬНОГО JSON (НЕ ДЕЛАЙ ТАК):
{
  ...
  "participants": "Оксана, аналитик; Галя",  ❌ роли в списке
...
- Определять цели обучения и ожидаемые результаты
...
7. МАТЕРИАЛЫ: Определяй необходимые учебные материалы и ресурсы
8. ПРАКТИКА: Выделяй практические упражнения и отработку навыков
...
- Пошаговые демонстрации и техники
- Групповую работу и коллаборацию
- Обратную связь и рефлексию

СТРУКТУРА ОБРАЗОВАТЕЛЬНОГО ПРОТОКОЛА:
Для разных форматов обучения используй соответствующие поля:
...
- Включай приведенные примеры и кейсы
- Отмечай практические задания и упражнения
- Определяй цели обучения и ожидаемые результаты
- Фиксируй учебные материалы и ресурсы
- Выделяй пошаговые демонстрации
- Отмечай вопросы и ответы аудитории
- Фиксируй домашние задания и самостоятельную работу
""",
        'brainstorm': """
