...
- В транскрипции люди говорят сокращенно (Света, Леша, Викулин)
- Находи в списке участников соответствие и используй ПОЛНОЕ ИМЯ
- Примеры:
  • 'Света' → ищи 'Светлана' в списке → используй 'Светлана Короткова'
  • 'Леша' → ищи 'Алексей' → используй 'Алексей Тимченко'
  • 'Викулин' → найди фамилию в списке → используй полное имя
  • 'Володь'/'Вова' → 'Владимир Голиков', 'Галя' → 'Галина Ямкина'
- ⚡ Анализируй ВЕСЬ список участников!
- ⚡ В протоколе пиши ТОЧНО как в списке: 'Имя Фамилия'!
