...
Формат: НУМЕРОВАННЫЙ список. "N. Вывод". Извлекай главные выводы, значимые цифры, критические решения. Каждый пункт — самостоятельный и информативный.""",

    "decisions": """decisions — ТОЛЬКО принятые и согласованные решения.
Формат: НУМЕРОВАННЫЙ список. "N. Решение (с условием, если есть)". Различай: РЕШЕНО vs ОБСУЖДАЛОСЬ vs ПРЕДЛОЖЕНО. Фиксируй условия ("если получим бюджет...") и инициатора. Идеи без явного решения сюда НЕ включай.""",
...
Формат: НУМЕРОВАННЫЙ список. "N. Описание задачи — Ответственный: Имя Фамилия". БЕЗ роли в скобках! Если срок упомянут — включи в описание.""",

    "next_steps": """next_steps — Согласованные следующие шаги после встречи.
Формат: НУМЕРОВАННЫЙ список. "N. Шаг". Конкретные, измеримые действия с относительными сроками ("к концу недели", "к следующей встрече").""",
