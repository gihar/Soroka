...
Формат: "Планёрка команды продукта", "Согласование бюджета Q3". Извлекай из темы обсуждения или повестки. Без кавычек, без слова "протокол", без даты (для неё есть поле date). Если тему не определить — оставь пустым.""",
