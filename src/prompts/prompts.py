...
Формат: "Имя Фамилия\\nИмя Фамилия". Извлекай из представлений, обращений, упоминаний. Игнорируй третьих лиц, не присутствующих на встрече. Если имя не определить — пиши "Участник N" (по номеру метки SPEAKER_N), а не саму метку.""",
...
Формат: НУМЕРОВАННЫЙ список. "N. Вывод". Извлекай главные выводы, значимые цифры, критические решения. Каждый пункт — самостоятельный и информативный. Только additive: дословно НЕ повторяй формулировки из Решений и Задач.""",
...
Формат: НУМЕРОВАННЫЙ список. "N. Шаг". Конкретные, измеримые действия с относительными сроками ("к концу недели", "к следующей встрече"). Только additive: дословно НЕ повторяй формулировки из Решений и Задач.""",
...
Формат: НУМЕРОВАННЫЙ список. "N. **Риск/Блокер**: описание и план митигации". Различай риски (потенциальные) и блокеры (текущие).""",
