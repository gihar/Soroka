...
- managers: Список руководителей через запятую (для управленческих встреч)
- platform: Платформа проведения (для онлайн-встреч)
...
- tasks: Задачи и распределение ответственности (каждая с новой строки через \\n)
- next_steps: Следующие шаги и контрольные точки (пункты списком через \\n)
- deadlines: Сроки выполнения задач
- issues: Выявленные проблемы и вопросы
- questions: Открытые вопросы
- risks_and_blockers: Риски и блокеры
- technical_issues: Технические вопросы и проблемы
...
- dialogue_analysis: Анализ диалога и взаимодействия
- speakers_summary: Краткая характеристика участников
- learning_objectives: Цели обучения (для образовательных встреч)
- key_concepts: Ключевые концепции и определения
- examples_and_cases: Примеры и кейсы
- practical_exercises: Практические упражнения
...
- Анализируй вклад каждого участника
- Фиксируй технические детали и архитектурные решения
- Извлекай образовательные элементы (цели, концепции, примеры) для обучающих встреч
- Определяй риски, блокеры и следующие шаги
- Сохраняй диалоговое взаимодействие между участниками
...
- managers: Список руководителей через запятую
- platform: Платформа проведения онлайн-встречи
...
- tasks: Задачи и распределение ответственности через \\n
- next_steps: Следующие шаги и контрольные точки через \\n
- deadlines: Сроки выполнения задач
- issues: Выявленные проблемы и вопросы
- questions: Открытые вопросы
- risks_and_blockers: Риски и блокеры
