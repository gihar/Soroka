...
class Settings(BaseSettings):
    ...
    max_external_file_size: int = Field(2 * 1024 * 1024 * 1024, description="Максимальный размер файла из внешних источников (Google Drive, Яндекс.Диск, Synology Drive) в байтах")
