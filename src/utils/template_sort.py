...
# Глифов нет намеренно (критика v10): 📋 уже значит «Повестка дня» в протоколе,
# ⚙️ — «Настройки». Категория в списке из четырёх кнопок читается и без метки,
# а глиф с двумя значениями не маркирует ничего.
CATEGORY_LABELS = {
    "general": "Общие",
