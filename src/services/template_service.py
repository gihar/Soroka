...
*Протокол составлен автоматически*""",
            ...
            },
            {
                ...
                "description": "Шаблон для деловых встреч, обсуждения контрактов, коммерческих вопросов и переговоров",
                "category": "business",
                "tags": ["business", "commercial", "meeting"],
                "keywords": ["деловой", "бизнес", "коммерческий", "контракт", "сделка", "переговоры", "финансы"],
                "content": """# Деловая встреча

{% if meeting_title or meeting_date or meeting_time %}
## 📋 Основная информация
{% if meeting_title %}**Тема встречи:** {{ meeting_title }}
{% endif %}{% if meeting_date %}**Дата:** {{ meeting_date }}
{% endif %}{% if meeting_time %}**Время:** {{ meeting_time }}
{% endif %}{% if participants %}**Участники:** {{ participants }}
{% endif %}
{% endif %}
